...
When(/^I open server state scenario menu and select "(Reset server|Copy to clipboard|Update with clipboard|Delete scenario)" option$/, async (t: TestController, [text]: [string]) => {
